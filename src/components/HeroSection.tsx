    ...
    return (
        ...
        mx-auto py-10 md:py-0">
            ...
            <div className="p-4 relative z-10 w-full text-center">
                ...
                >Master Full Stack Development <br /> Build, Create, Innovate!</h1>
                <p
                    className="mt-4 font-normal text-base md:text-lg
                text-neutral-300 max-w-lg mx-auto"
                >Drive into our comprehensive programming courses and transform
                    your coding skills to a different level. Whether you are a beginner
                    or looking to refine your skills, join us to unlock your true potential.
                </p>
                <div className="mt-4">
                    <Link href={"/courses"}>
