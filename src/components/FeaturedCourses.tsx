...
function FeaturedCourses() {
    const featuredCourses = CourseData.technologies.filter((tech: Technology) => tech.isfeatured)
        ...
        <div className='py-12 bg-gray-900'>
            ...
            <div className='mt-10'>
                ...
                lg:grid-cols-3 gap-8 justify-center'>
                    {featuredCourses.map((tech: Technology) => (
                        <div key={tech.id} className="flex justify-center">
                            ...
                            '>
                                ...
                                flex-grow'>
                                    ...
                                    text-black mt-4 mb-2 dark:text-neutral-200
                                    '>{tech.title}</p>
                                    <p className='text-sm
                                    text-neutral-600
